...
float objectEmissivity = 0.1; // Emissivity value of the individual object being measured
...
void loop(){
    ...
    Serial.print("Object temperature (C): "); Serial.println(CtoF(temperatures.object)); // Print object temp
    Serial.print("Ambient temperature (C): "); Serial.println(CtoF(temperatures.ambient)); // Print ambient temp
    delay(1000);
}
