...
void loop(){
    ...
    Serial.print("Object temperature (C): "); Serial.println(CtoF(temperatures.object)); // Print out object temp
    Serial.print("Ambient temperature (C): "); Serial.println(CtoF(temperatures.ambient)); // Print out ambient temp
    delay(1000);
}
